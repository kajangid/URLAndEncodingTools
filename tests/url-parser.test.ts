...
import { parseUrl, tryParseUrl, toUrlString } from '../src/url-parser/index.js';
...
describe('tryParseUrl', () => {
  it('returns null on invalid URL', () => {
    expect(tryParseUrl('nope')).toBeNull();
  });

  it('returns parsed object on valid URL', () => {
    const r = tryParseUrl('https://example.com/');
...
describe('toUrlString', () => {
  it('round-trips through edit + stringify', () => {
