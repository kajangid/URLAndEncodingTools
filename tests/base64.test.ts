...
describe('encode / decode (standard Base64)', () => {
...
describe('encodeUrl / decodeUrl (Base64URL)', () => {
...
describe('encodeBytesUrl / decodeBytesUrl', () => {
  it('produces URL-safe bytes', () => {
...
describe('isBase64 / isBase64Url', () => {
  it('isBase64 accepts canonical form', () => {
  ...
  it('isBase64Url accepts URL form', () => {
