...
import { stringify, parse, appendParams, removeParams } from './index.js';
...
describe('query-string', () => {
  ...
  it('appendParams merges into existing query', () => {
    expect(appendParams('https://example.com/?a=1', { b: '2' })).toBe('https://example.com/?a=1&b=2');
  });

  it('appendParams overwrites duplicate keys', () => {
    expect(appendParams('https://example.com/?a=1', { a: '2' })).toBe('https://example.com/?a=2');
  });

  it('removeParams removes given keys', () => {
    expect(removeParams('https://example.com/?a=1&b=2&c=3', ['b'])).toBe('https://example.com/?a=1&c=3');
  });
});
